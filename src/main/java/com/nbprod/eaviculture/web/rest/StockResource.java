...
/**
 * REST controller for managing {@link com.nbprod.eaviculture.domain.Stock}.
 */
@RestController
@RequestMapping("/api")
public class StockResource {
    ...
    public ResponseEntity<StockDTO> updateStock(@RequestBody StockDTO stockDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, stockDTO.getId().toString()))
            .body(result);
    }
